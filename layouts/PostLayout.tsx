      ...
      <article>
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-gray-200 pb-8 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0 dark:divide-gray-700">
            <div className="contents xl:col-start-1 xl:row-span-2 xl:block">
              <dl className="order-0 pt-6 pb-10 xl:border-b xl:border-gray-200 xl:pt-11 xl:dark:border-gray-700">
            ...
            <div className="order-1 divide-y divide-gray-200 xl:col-span-3 xl:row-span-2 xl:pb-0">
